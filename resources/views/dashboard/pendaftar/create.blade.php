        ...
        <div class="row justify-content-center font">
            ...
            <main class="form-register w-100 m-auto container p-3 bg-light rounded">
                ...
                <form action="/pendaftaran-santri/daftar" method="POST">
                    ...
                    <div class="form-floating mb-2">
                        <input type="date" class="form-control rounded-top " format="dd-mm-yyyy" name="tglLahir"
                            id="tglLahir" placeholder="Tanggal Lahir" required value="{{ old('tglLahir') }}">
                    ...
                    <button class=" btn btn-lg my-3 text-light" style="background-color: #0c9488;" type="submit"><span
                            data-feather="save"></span> Simpan</button>
