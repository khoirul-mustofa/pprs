...
<div class="row justify-content-center font">
    <h1 class="h2 pt-3 pb-2 text-md-start text-center">Update Data Pendaftar</h1>
        ...
        <main class="form-register w-100 m-auto container bg-light rounded">
            ...
            <form action="/dashboard/pendaftaran-santri/{{ $pendaftar->id }}/edit" method="POST">
                ...
                <div class="form-floating mb-2 mt-3">
                    <input type="text" class="form-control rounded-top" name="nama" id="nama" placeholder="Nama" required value="{{ old('nama', $pendaftar->nama) }}">
                    <label for="nama">Nama Lengkap Sesuai Ijazah</label>
                </div>
                <div class="form-floating mb-2">
                    <input type="text" class="form-control rounded-top" name="tempatLahir" id="tempatLahir" placeholder="Tempat Lahir" required value="{{ old('tempatLahir', $pendaftar->templahir) }}">
                ...
                <div class="form-floating mb-2 mt-1">
                    <input type="number" class="form-control rounded-top @error('nik') is-invalid @enderror" name="nik" id="nik" placeholder="NIK" required value="{{ old('nik',$pendaftar->nik) }}">
                ...
                <hr class="w-100 clearfix my-3" />
                <div class="form-floating mb-2 mt-3">
                    <input type="text" class="form-control rounded-top" name="desa" id="desa" placeholder="Desa" required value="{{ old('desa',$pendaftar->desa) }}">
                    <label for="desa">Desa</label>
                </div>
                <div class="form-floating mb-2 mt-3">
                    <input type="text" class="form-control rounded-top" name="kecamatan" id="kecamatan" placeholder="kecamatan" required value="{{ old('kecamatan', $pendaftar->kecamatan) }}">
                    <label for="kecamatan">Kecamatan</label>
                </div>
                <div class="form-floating mb-2 mt-3">
                    <input type="text" class="form-control rounded-top" name="kabupaten" id="kabupaten" placeholder="Kabupaten" required value="{{ old('kabupaten',$pendaftar->kabupaten) }}">
                    <label for="kabupaten">Kabupaten</label>
                </div>
                <div class="form-floating mb-2 mt-3">
                    <input type="text" class="form-control rounded-top" name="provinsi" id="provinsi" placeholder="Provinsi" required value="{{ old('provinsi',$pendaftar->provinsi) }}">
                    <label for="provinsi">Provinsi</label>
                </div>
                <label class="px-2 mt-2">Email guna mengirimkan file</label>
                <div class="form-floating mb-2 mt-1">
                    <input type="email" class="form-control rounded-top" name="email" id="email" placeholder="Email" required value="{{ old('email',$pendaftar->email) }}">
                ...
                <button class=" btn btn-lg my-3 text-light" style="background-color: #0c9488;" type="submit">Update</button>
