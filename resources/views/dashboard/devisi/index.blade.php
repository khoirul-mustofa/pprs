...
@section('container')
    <div class="container col-lg-9">
        ...
        <div class="table-responsive">
            <a href="/dashboard/devisi/create" class="btn btn-primary mb-3 ms-1 mt-1"><span data-feather="plus"></span>
                Tambah Devisi</a>
                    ...
                    @foreach ($data as $b)
                        <tr>
                            ...
                            <td class="text-center border">
                                <a href="/dashboard/devisi/{{ $b->id }}/edit" class="badge bg-warning"><span
                                        data-feather="edit"></span></a>

                                <form action="/dashboard/devisi/{{ $b->id }}" method="post" class="d-inline">
                                    @csrf
                                    @method('delete')
