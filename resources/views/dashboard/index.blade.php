...
@section('container')
    ...
    <div class="row mt-3">
            ...
            <a href="/dashboard/pendaftaran-santri" class="text-decoration-none">
                <div class="card shadow-lg p-1">
                    <div class="row">
                        ...
                        <div class="col">
                            <h5 class="text-dark mt-2 text-start ">Santri Proses</h5>
            ...
            <a href="/dashboard/pendaftaran-santri" class="text-decoration-none">
                <div class="card shadow-lg p-1">
                    <div class="row">
                        ...
                        <div class="col">
                            <h5 class="text-dark mt-2 text-start ">Santri Ngalong</h5>
                            <h5 class="text-dark mt-1 me-3 text-start ">{{ $ngalong }}</h5>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-md-12 col-lg-4 col-xxl-3 mt-3">
            <a href="/dashboard/profil" class="text-decoration-none">
                <div class="card shadow-lg p-1">
                    <div class="row">
                        <div class="col-3 col-md-2 col-lg-3  col-xxl-3 bg-success rounded-2 ms-3 my-1 p-3">
                            <img src="{{ asset('storage/favicon/icons8-school-40.png') }}" />
                        </div>
                        <div class="col">
                            <h5 class="text-dark mt-2 text-start ">Profil</h5>
                            <h5 class="text-dark mt-1 me-3 text-start ">{{ $profil }}</h5>
                        </div>
                    </div>
                </div>
            </a>
