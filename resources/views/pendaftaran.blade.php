    ...
    <div class="row justify-content-center font mt-1">
        <div class="col-md-9">
            <main class="form-register w-100 m-auto container bg-light rounded">
                ...
                <h6 class="text-center fw-light">Sekretariat : JL. KH. Busthomil Karim Purwosari Kec. Padang Ratu Kab.
                    Lampung Tengah 34176</h6>
                ...
                <form action="/pendaftaran-santri/daftar" method="POST">
                    ...
                    <div class="form-floating mb-2">
                        <input type="text" class="form-control rounded-top" name="tempatLahir" id="tempatLahir"
                            placeholder="Tempat Lahir" required value="{{ old('tempatLahir') }}">
                        <label for="tempatLahir">Tempat Lahir</label>
                    </div>
                    <div class="form-floating mb-2">
                        <input type="date" class="form-control rounded-top " name="tglLahir" id="tglLahir"
                            placeholder="Tanggal Lahir" required value="{{ old('tglLahir') }}">
                    ...
                    <div class="form-floating mb-2 mt-3">
                        <input type="text" class="form-control rounded-top" name="desa" id="desa"
                            placeholder="Desa" required value="{{ old('desa') }}">
                    ...
                    <div class="form-floating mb-2 mt-3">
                        <input type="text" class="form-control rounded-top" name="kabupaten" id="kabupaten"
                            placeholder="Kabupaten" required value="{{ old('kabupaten') }}">
                    ...
                    <div class="form-floating mb-2 mt-3">
                        <input type="text" class="form-control rounded-top" name="riwayatMedis" id="riwayatMedis"
                            placeholder="Riwaya Medis" value="{{ old('riwayatMedis') }}">
                    ...
                    <div class="form-floating mb-2 mt-1">
                        <input type="number" class="form-control rounded-top" name="noHp" id="noHp"
                            placeholder="Nomor Hp" required value="{{ old('noHp') }}">
                    ...
                    <button class=" btn btn-lg my-3 text-light" style="background-color: #0c9488;" type="submit"
                        onclick="return confirm('Pastikan Data anda benar!')">Kirim</button>
